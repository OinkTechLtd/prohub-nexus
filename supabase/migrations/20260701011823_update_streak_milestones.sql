...
BEGIN
  ...
  ELSIF streak.last_visit_date = CURRENT_DATE - 1 THEN
    ...
    ELSIF new_streak = 60 THEN milestone_bonus := 500;
    ELSIF new_streak = 100 THEN milestone_bonus := 1000;
    ELSIF new_streak = 365 THEN milestone_bonus := 5000;
    ELSIF new_streak = 730 THEN milestone_bonus := 10000;
    ELSIF new_streak = 1000 THEN milestone_bonus := 15000;
    ELSIF new_streak = 2000 THEN milestone_bonus := 25000;
    ELSIF new_streak = 3000 THEN milestone_bonus := 35000;
    ELSIF new_streak = 4000 THEN milestone_bonus := 50000;
    END IF;
