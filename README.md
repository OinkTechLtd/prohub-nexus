...
**ProHub Nexus** — современное веб-приложение для создания и ведения форумов. Платформа даёт возможность общаться в тематических разделах, создавать темы, оставлять сообщения, управлять профилями и модерировать контент. Проект построен на реактивном стеке и готов к масштабированию.

---

## 🚀 Демо

> [prohub-forumru](https://prohub-forumru.tatnet.app)
...
- [API (форумные эндпоинты)](#api-форумные-эндпоинты)
...
Создайте файл `.env` (см. следующий раздел).
...
Публичное API доступно по пути `/api`.
...
3. Внесите изменения и зафиксируйте: `git commit -m 'Add awesome feature'`
4. Отправьте в свой форк: `git push origin feature/awesome-feature`
...
Проект является проприетарным и принадлежит **OinkTech Ltd**. Использование без письменного разрешения запрещено.

---

## 👥 Участники

- [OinkTechLtd](https://github.com/OinkTechLtd)
...
> ⚡ Сделано с ❤️ на [Vite](https://vitejs.dev/) + [React](https://react.dev/) + [shadcn/ui](https://ui.shadcn.com/).
