  ...
  return (
    <div className="min-h-screen bg-[#0a0118] text-gray-200">
      ...
      <main className="container mx-auto max-w-4xl px-4 py-6">
        ...
        <div className="rounded-lg border border-[#2a1145] bg-[#120425] p-4 md:p-6">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3 border-t border-[#2a1145] pt-4">
            ...
            <button onClick={handleOpenResource} className="inline-flex items-center gap-2 rounded bg-fuchsia-600 px-4 py-2 text-sm text-white hover:bg-fuchsia-700">
        ...
        <section className="mt-6 rounded-lg border border-[#2a1145] bg-[#120425] p-4 md:p-6">
          ...
          {comments.length === 0 ? (
            ...
            <div className="space-y-3">
              {comments.map((comment) => (
                <div key={comment.id} className="rounded-lg border border-[#2a1145] bg-[#1a0b2e]/40 p-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm text-gray-400">
                      {comment.profiles?.username && (
                        <StyledUsername
                          ...
                          profilePath={`/flexdev/profile/${encodeURIComponent(comment.profiles.username)}`}
                        />
                      )}
          ...
          {user ? (
            <div className="mt-4 space-y-3">
              <textarea value={newComment} onChange={(e) => setNewComment(e.target.value)} rows={4} className="w-full rounded border border-[#2a1145] bg-[#1a0b2e] px-3 py-2 text-sm text-gray-100" placeholder="Оставить комментарий..." />
              <button onClick={handleSubmitComment} disabled={submitting} className="inline-flex items-center gap-2 rounded bg-fuchsia-600 px-4 py-2 text-sm text-white hover:bg-fuchsia-700 disabled:opacity-50">
...
export default FlexDevResourceView;