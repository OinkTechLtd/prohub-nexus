...
const FlexDevCreateTopic = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate(`/flexdev/topic/${newTopic.id}`);
    } catch (error: any) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full bg-[#1a0b2e] border border-[#2a1145] rounded px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-fuchsia-500"
              required
            >
          ...
          <div>
            ...
            <textarea
              ...
              rows={10}
              className="w-full bg-[#1a0b2e] border border-[#2a1145] rounded-b px-3 py-2 text-sm text-gray-200 focus:outline-none focus:border-fuchsia-500 resize-y min-h-[200px]"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="px-6 py-2 bg-fuchsia-600 hover:bg-fuchsia-700 disabled:opacity-50 text-white text-sm rounded transition-colors"
          >
...
export default FlexDevCreateTopic;
